package com.xiao9.user.infrastructure.security;

import com.xiao9.user.domain.IUserRepository;
import com.xiao9.user.domain.User;
import com.xiao9.user.infrastructure.security.error.UserNotActivatedException;
...
@Service
public class UsernameOrEmailAuthDetailService implements UserDetailsService {

    private final IUserRepository userRepository;

    public UsernameOrEmailAuthDetailService(IUserRepository userRepository) {
